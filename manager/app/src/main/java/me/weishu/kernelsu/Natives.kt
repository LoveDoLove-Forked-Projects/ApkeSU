...
object Natives {
    ...
    val minimalSupportedKernel: Int
        get() = 32377
    ...
    /**
     * AVC log spoof can be disabled temporarily.
     *  0: disabled
     *  1: enabled
     */
    ...
    fun requireNewKernel(): Boolean {
        return (version != -1 && version < minimalSupportedKernel) || checkUAPIMismatch()
    }
